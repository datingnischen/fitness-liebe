...
export default async function MagazineDetailPage({ params }: PageProps) {
  ...
  const content = relativizeInternalLinks(stripPublishedBookSchema(renderedContent));
          ...
          "@graph": [
            {
              ...
              inLanguage: "de-DE",
              mainEntityOfPage: `${SITE_URL}/magazin/${slug}`,
              author: authorProfile
                ? { "@type": authorProfile.slug === "redaktion" ? "Organization" : "Person", name: authorProfile.name, url: `${SITE_URL}${authorProfile.profileUrl}` }
                : undefined,
              publisher: { "@type": "Organization", name: "fitness-liebe.de", url: SITE_URL },
            ...
            },
            {
              ...
              itemListElement: [
                ...
                { "@type": "ListItem", position: 2, name: world.name, item: `${SITE_URL}/magazin/thema/${world.id}` },
                { "@type": "ListItem", position: 3, name: entry.title, item: `${SITE_URL}/magazin/${slug}` },
              ],
            },
          ],
        }
