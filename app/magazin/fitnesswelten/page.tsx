...
import { SITE_URL, getAllMagazineEntries, getEntryCoverImage, type MagazineEntry } from "@/lib/wordpress";
...
const PAGE_URL = `${SITE_URL}/magazin/fitnesswelten`;
...
export default async function FitnessweltenPage() {
