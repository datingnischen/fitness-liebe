...
import { ABOUT_SOCIAL_MEDIA_PATH, DATING_TIPS_PATH, aboutOverviewCanonical } from "@/lib/about-section";
...
export const metadata: Metadata = {
  ...
  alternates: { canonical: aboutOverviewCanonical() },
  openGraph: { title: TITLE, description: DESCRIPTION, url: aboutOverviewCanonical() },
};
      ...
      <section className="content-section">
        ...
        <div className="grid-three">
          {HOME_TRUST_TILES.map((tile) => (
            <a key={tile.path} className="panel-card trust-link-card" href={publicUrl("de", tile.path)}>
