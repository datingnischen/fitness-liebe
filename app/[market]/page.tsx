...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: { title: TITLE, description: DESCRIPTION, url: publicUrl(market, "/"), images: [HOME_HERO_IMAGE] },
  };
}
          ...
          <div className="fl-hero-copy">
            ...
            <div className="fl-hero-actions">
              ...
              {cities.length ? (
                ...
                <Link className="button fl-hero-ghost" href="/magazin">
                  Zum Fitness-Magazin
                </Link>
              )}
            </div>
      ...
      <div className="shell home-shell">
        ...
        <section className="fl-trust-grid" aria-label="Darauf kannst du dich verlassen">
          {HOME_TRUST_TILES.map((tile) => (
            <a key={tile.path} className="fl-trust-tile" href={platformUrl(tile.path)}>
        ...
        <section className="fl-section" aria-labelledby="features-titel">
          ...
          <div className="fl-feature-grid">
            {HOME_FEATURES.map((feature) => (
              <a key={feature.path} className="fl-feature-card" href={platformUrl(feature.path)}>
        ...
        <section className="fl-story" aria-labelledby="story-titel">
          ...
          <div className="fl-story-copy">
            ...
            <a className="button button-primary" href={platformUrl("/unsere-erfolgsgeschichten.html")}>
